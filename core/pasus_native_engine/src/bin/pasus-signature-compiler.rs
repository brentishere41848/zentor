...
use pasus_native_engine::signatures::pack_format::SignaturePack;
use pasus_native_engine::signatures::signature_compiler;
...
fn print_help() {
    println!(
        "pasus-signature-compiler --input source.json --output pasus_core.psig --metadata pasus_core.metadata.json [--version 0.1.0]"
    );
}
