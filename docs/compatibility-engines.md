...
Zentor Native Engine is the primary engine.
...
Default Guard builds do not call these engines in the process-start or driver-verdict path. ZNE native verdicts are evaluated first and are sufficient for EICAR/test-threat decisions.
